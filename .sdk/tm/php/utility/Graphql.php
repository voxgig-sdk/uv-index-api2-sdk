...
// UvIndexApi2 SDK utility: graphql
//
...
class UvIndexApi2Graphql
{
    ...
    // equivalent.
    public static function body(UvIndexApi2Context $ctx): mixed
    {
    ...
    public static function errors(UvIndexApi2Context $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
