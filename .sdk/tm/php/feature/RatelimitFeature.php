...
// UvIndexApi2 SDK ratelimit feature
...
class UvIndexApi2RatelimitFeature extends UvIndexApi2BaseFeature
{
    ...
    private function _acquire(UvIndexApi2Context $ctx): void
    {
    ...
    private function _track(UvIndexApi2Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
