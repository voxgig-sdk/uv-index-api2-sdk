...
class UvIndexApi2RbacFeature extends UvIndexApi2BaseFeature
{
    ...
    private function _required(UvIndexApi2Context $ctx): ?string
    {
    ...
    private function _reject(UvIndexApi2Context $ctx, string $required): void
    {
    ...
    private function _track(UvIndexApi2Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
