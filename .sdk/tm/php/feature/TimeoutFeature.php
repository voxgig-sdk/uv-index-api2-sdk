...
// UvIndexApi2 SDK timeout feature
...
class UvIndexApi2TimeoutFeature extends UvIndexApi2BaseFeature
{
    ...
    private function _with_timeout(UvIndexApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(UvIndexApi2Context $_ctx, float $ms): void
    {
        $client = $this->client;
