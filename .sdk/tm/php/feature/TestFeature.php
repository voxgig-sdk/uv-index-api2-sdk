...
// UvIndexApi2 SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class UvIndexApi2TestFeature extends UvIndexApi2BaseFeature
{
    ...
    public function init(UvIndexApi2Context $ctx, array $options): void
    {
        ...
        $test_fetcher = function (UvIndexApi2Context $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = UvIndexApi2Param::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (UvIndexApi2Context $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(UvIndexApi2Context $ctx, $op, $args): array
    {
