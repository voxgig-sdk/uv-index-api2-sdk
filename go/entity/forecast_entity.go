...
import (
	...
	vs "github.com/voxgig-sdk/uv-index-api2-sdk/go/utility/struct"
)

type ForecastEntity struct {
	name    string
	client  *core.UvIndexApi2SDK
...
func NewForecastEntity(client *core.UvIndexApi2SDK, entopts map[string]any) *ForecastEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ForecastEntity) GetName() string { return e.name }
...
func (e *ForecastEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ForecastEntity) Deleted() bool {
	return e.deleted
}


func (e *ForecastEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewForecastEntity(e.client, opts)
}

func (e *ForecastEntity) Data(args ...any) any {
...
func (e *ForecastEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Forecast; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ForecastEntity) DataTyped(data ...Forecast) Forecast {
	if len(data) > 0 {
		return typedFrom[Forecast](e.Data(asMap(data[0])))
	}
	return typedFrom[Forecast](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Forecast (all fields
// optional at the wire level).
func (e *ForecastEntity) MatchTyped(match ...Forecast) Forecast {
	if len(match) > 0 {
		return typedFrom[Forecast](e.Match(asMap(match[0])))
	}
	return typedFrom[Forecast](e.Match())
}
...
func (e *ForecastEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ForecastEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ForecastEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ForecastListMatch and returns []Forecast. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ForecastEntity) ListTyped(reqmatch ForecastListMatch, ctrl map[string]any) ([]Forecast, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Forecast](res), nil
}



func (e *ForecastEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ForecastEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ForecastEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ForecastEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
