// Command UvIndexApi2-mcp is an MCP server exposing the UvIndexApi2
// SDK as MCP tools.
//
// Two tools are registered:
//
//	UvIndexApi2_list  — list records of an entity
//	UvIndexApi2_load  — load a single record of an entity
//
