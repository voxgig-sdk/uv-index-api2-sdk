...
type Args struct {
	Entity string         `json:"entity" jsonschema:"forecast"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.UvIndexApi2SDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "uv-index-api2_list",
		Description: "List records from UvIndexApi2. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "uv-index-api2_load",
		Description: "Load a single record from UvIndexApi2. " +
...
func runOp(client *sdk.UvIndexApi2SDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.UvIndexApi2SDK, name string) (sdk.UvIndexApi2Entity, error) {
	switch strings.ToLower(name) {
	case "forecast":
		return client.Forecast(nil), nil
