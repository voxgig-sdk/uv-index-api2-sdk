...
AQL-driven CLI and REPL for the UvIndexApi2 SDK. Positional arguments are
...
./uv-index-api2-cli load 1 forecast
./uv-index-api2-cli load '{id:1}' forecast
