...
func registerSDKWords(r *eng.Registry, client *sdk.UvIndexApi2SDK) {
...
func runOp(client *sdk.UvIndexApi2SDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
