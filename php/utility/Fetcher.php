...
// UvIndexApi2 SDK utility: fetcher

class UvIndexApi2Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; UvIndexApi2SDK/1.0)';
    ...
    public static function call(UvIndexApi2Context $ctx, string $fullurl, array $fetchdef): array
    {
