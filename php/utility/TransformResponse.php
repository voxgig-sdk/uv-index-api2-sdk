...
// UvIndexApi2 SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class UvIndexApi2TransformResponse
{
    public static function call(UvIndexApi2Context $ctx): mixed
    {
        ...
        $transform = UvIndexApi2Helpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
