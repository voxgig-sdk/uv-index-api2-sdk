...
// UvIndexApi2 SDK clienttrack feature
...
class UvIndexApi2ClienttrackFeature extends UvIndexApi2BaseFeature
{
    ...
    public function PostConstruct(UvIndexApi2Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'UvIndexApi2-SDK';
