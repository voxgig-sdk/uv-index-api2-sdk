...
// UvIndexApi2 SDK netsim feature
...
class UvIndexApi2NetsimFeature extends UvIndexApi2BaseFeature
{
    ...
    private function _simulate(UvIndexApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(UvIndexApi2Context $ctx, array $applied): void
    {
        $client = $this->client;
