...
// UvIndexApi2 SDK metrics feature
...
class UvIndexApi2MetricsFeature extends UvIndexApi2BaseFeature
{
    ...
    private function _record(UvIndexApi2Context $ctx, bool $ok): void
    {
