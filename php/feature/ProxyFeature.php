...
class UvIndexApi2ProxyFeature extends UvIndexApi2BaseFeature
{
    ...
    public function init(UvIndexApi2Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (UvIndexApi2Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
