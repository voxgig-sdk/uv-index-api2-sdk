...
class UvIndexApi2CacheFeature extends UvIndexApi2BaseFeature
{
    ...
    private function _through(UvIndexApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
