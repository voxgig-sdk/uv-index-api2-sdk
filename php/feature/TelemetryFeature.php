...
// UvIndexApi2 SDK telemetry feature
...
class UvIndexApi2TelemetryFeature extends UvIndexApi2BaseFeature
{
    ...
    private function _close(UvIndexApi2Context $ctx, bool $ok): void
    {
