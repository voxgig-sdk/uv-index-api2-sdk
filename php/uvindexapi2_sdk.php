...
class UvIndexApi2SDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = UvIndexApi2Helpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = UvIndexApi2Helpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!UvIndexApi2Features::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, UvIndexApi2Features::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return UvIndexApi2Utility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = UvIndexApi2Helpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = UvIndexApi2Helpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = UvIndexApi2Helpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new UvIndexApi2Error($op . "_allow",
                "UvIndexApi2SDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = UvIndexApi2Helpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new UvIndexApi2Error("graphql_error",
                "UvIndexApi2SDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Forecast($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_forecast === null) {
                $this->_forecast = new ForecastEntity($this, null);
            }
            return $this->_forecast;
        }
        return new ForecastEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new UvIndexApi2SDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
