...
The PHP SDK for the UvIndexApi2 API — an entity-oriented client using PHP conventions.
...
```
php/
├── uvindexapi2_sdk.php          -- Main SDK class
...
The main class (`uvindexapi2_sdk.php`) exports the SDK class
