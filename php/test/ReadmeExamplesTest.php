...
// UvIndexApi2 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (UvIndexApi2SDK::test)
...
{
    private const SDK_CLASS = 'UvIndexApi2SDK';
    ...
    private const SDK_BASE = 'uvindexapi2_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../uvindexapi2_sdk.php';
