...
require_relative 'UvIndexApi2_types'
...
class UvIndexApi2SDK
  ...
  def initialize(options = {})
    ...
    feature_opts = UvIndexApi2Helpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = UvIndexApi2Helpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, UvIndexApi2Features.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    UvIndexApi2Utility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = UvIndexApi2Helpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = UvIndexApi2Helpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = UvIndexApi2Helpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def raw_request(fetchargs = {})
    ...
    if fetched.is_a?(Hash)
      status = UvIndexApi2Helpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = UvIndexApi2Error.new(
        "graphql_error", "UvIndexApi2SDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = UvIndexApi2SDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
