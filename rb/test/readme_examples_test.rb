...
#      offline in seeded test mode (UvIndexApi2SDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "UvIndexApi2_sdk.rb")
  SDK_CLASS = "UvIndexApi2SDK"
