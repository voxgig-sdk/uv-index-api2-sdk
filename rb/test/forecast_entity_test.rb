...
class ForecastEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set UVINDEXAPI__TEST_FORECAST_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def forecast_basic_setup(extra)
  ...
  entid_env_raw = ENV["UVINDEXAPI__TEST_FORECAST_ENTID"]
