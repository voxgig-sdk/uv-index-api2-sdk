...
function runner.env_override(m)
  local live = runner.getenv("UVINDEXAPI2_TEST_LIVE")
  local override = runner.getenv("UVINDEXAPI2_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("UVINDEXAPI2_TEST_EXPLAIN")
