...
describe("ForecastDirect", function()
  it("should direct-list-forecast", function()
    local setup = forecast_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-forecast", setup.live and "live" or "unit")
