...
class UvIndexApi2TestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UvIndexApi2TestRunner.getenv("UVINDEXAPI2_TEST_LIVE")
        override = UvIndexApi2TestRunner.getenv("UVINDEXAPI2_TEST_OVERRIDE")
        ...
        explain = UvIndexApi2TestRunner.getenv("UVINDEXAPI2_TEST_EXPLAIN")
