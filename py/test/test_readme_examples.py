# UvIndexApi2 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions UvIndexApi2SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both UvIndexApi2SDK(...) and UvIndexApi2SDK.test(...) become
#      UvIndexApi2SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "uvindexapi2_sdk"
_SDK_CLASS = "UvIndexApi2SDK"
