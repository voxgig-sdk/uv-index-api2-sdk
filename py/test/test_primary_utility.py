...
from uvindexapi2_sdk.core.spec import UvIndexApi2Spec
from uvindexapi2_sdk.core.result import UvIndexApi2Result
from uvindexapi2_sdk.core.response import UvIndexApi2Response
from uvindexapi2_sdk.core.operation import UvIndexApi2Operation
from uvindexapi2_sdk.core.error import UvIndexApi2Error
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return UvIndexApi2Error(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = UvIndexApi2SDK.test(None, None)
        ...
        class TestInitFeature(UvIndexApi2BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(UvIndexApi2BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = UvIndexApi2Spec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = UvIndexApi2SDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = UvIndexApi2Operation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = UvIndexApi2SDK.test(None, setup_opts)
