...
from uvindexapi2_sdk.core.control import UvIndexApi2Control
...
from uvindexapi2_sdk.core.helpers import get_ctx_prop, to_map
...
class UvIndexApi2Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, UvIndexApi2Spec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, UvIndexApi2Result):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, UvIndexApi2Response):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return UvIndexApi2Error(code, msg, self)
