...
from uvindexapi2_sdk.utility import register

# Load features
from uvindexapi2_sdk.feature.base_feature import UvIndexApi2BaseFeature
from uvindexapi2_sdk.features import _has_feature, _make_feature
...
class UvIndexApi2SDK:
    ...
    def __init__(self, options=None):
        ...
        utility = UvIndexApi2Utility()
        self._utility = utility

        from uvindexapi2_sdk.config import shared_config
    ...
    def get_utility(self):
        return UvIndexApi2Utility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("UvIndexApi2SDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Forecast(self, data=None) -> "ForecastEntity":
        ...
        from uvindexapi2_sdk.entity.forecast_entity import ForecastEntity
        return ForecastEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "UvIndexApi2SDK":
        if sdkopts is None:
            sdkopts = {}
