...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.UVINDEXAPI2_TEST_LIVE ||
    'TRUE' === process.env.UVINDEXAPI2_TEST_OVERRIDE
  ) {
  ...
  m.UVINDEXAPI2_TEST_EXPLAIN = process.env.UVINDEXAPI2_TEST_EXPLAIN || m.UVINDEXAPI2_TEST_EXPLAIN
