...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.UV_INDEX_API2_TEST_LIVE ||
    'TRUE' === process.env.UV_INDEX_API2_TEST_OVERRIDE
  ) {
  ...
  m.UV_INDEX_API2_TEST_EXPLAIN = process.env.UV_INDEX_API2_TEST_EXPLAIN || m.UV_INDEX_API2_TEST_EXPLAIN
